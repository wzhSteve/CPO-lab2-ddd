...
from DynamicArray import cons, remove, length, member
from DynamicArray import reverse, set, to_list, from_list
from DynamicArray import find, filter, map, reduce
from DynamicArray import iterator, empty, concat
...
class TestDynamicArray(unittest.TestCase):
    ...
    def test_immutability(self) -> None:
        ...
        set(a, 0, 88)
        reverse(a)
        self.assertEqual(str(a), '[1, 2, 3, 4, 5, 6, 7, 8, 3, 4]')
